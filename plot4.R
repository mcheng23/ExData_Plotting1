...
par(mfrow = c(2, 2))
plot(df$TM, df$Global_active_power, type = "l", xlab = "", ylab = "Global Active Power")
plot(df$TM, df$Voltage, type = "l", xlab = "datetime", ylab = "voltage")
...
plot(df$TM, df$Global_reactive_power, type = "l", xlab = "datetime", ylab = "Global_reactive_power")
dev.off()
